import ProfileInventoryList from "../components/ProfileInventoryList";

export default function ProfileInventory() {
  return (
    <div className="bg-white flex flex-col items-center w-[1440px] box-sizing-border">
      <div className="bg-white flex flex-row justify-between p-[20px_80px_20px_80px] w-[1440px] box-sizing-border">
        ...
        <div className="flex flex-row box-sizing-border">
          ...
          <div className="rounded-[16px] bg-[#F5F5F5] flex flex-row p-[4px_4px_4px_16px] w-[89px] box-sizing-border">
            ...
            <div className="shadow-[0px_1px_4px_0px_rgba(0,0,0,0.12),0px_8px_20px_0px_rgba(0,0,0,0.02)] rounded-[12px] bg-white flex p-[13.3px_13.3px_13.4px_13.4px] w-[40px] h-[40px] box-sizing-border">
      ...
      <div className="flex flex-col items-center w-[fit-content] box-sizing-border">
        ...
        <div className="bg-white flex flex-col p-[16px_80px_80px_80px] w-[1440px] box-sizing-border">
          ...
          <ProfileInventoryList></ProfileInventoryList>
        </div>
      </div>
    </div>
  )
